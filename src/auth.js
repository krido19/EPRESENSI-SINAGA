    ...
    if (userSchoolId) {
      ...
      if (school) {
        ...
        tenantCfg = {
          ...
          schedulerSiangEnabled:  schoolCfg?.scheduler_siang_enabled ?? localCfg.schedulerSiangEnabled ?? true,
          ...
          siangHour:   schoolCfg?.siang_hour   ?? localCfg.siangHour   ?? 15,
          siangMinute: schoolCfg?.siang_minute  ?? localCfg.siangMinute  ?? 30,
          ...
          messageSiang:       schoolCfg?.message_siang       || localCfg.messageSiang       || '',
          messageSiangSudah:  schoolCfg?.message_siang_sudah || localCfg.messageSiangSudah  || '',
